    ...
    <div class="fundo-header">
        <div class="container-fluid">
            <div class="header-row">
                <!-- Mobile menu button -->
                <div class="mobile-menu-btn-wrap" style="display:block;">
                    <button class="btn-open-menu-desktop" id="btn-open-menu" aria-label="Abrir menu">
